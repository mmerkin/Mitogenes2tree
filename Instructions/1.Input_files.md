...
- [Mitochondrial genome reference fasta file]()
...
Create a galaxy account, upload the fasta file and run the tool MITOS2 to generate a SEQ file, ensuring to also change the genetic code if necessary:
...
An sbt file containing the header information is also required. This can be generated from the [ncbi submission portal](https://submit.ncbi.nlm.nih.gov/genbank/template/submission/) or [this example file](https://github.com/mmerkin/Mitogenes2tree/Example_files/Example_template.sbt) can be used instead.
